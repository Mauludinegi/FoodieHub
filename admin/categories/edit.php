...
if (isset($_POST['update'])) {
    ...
    $result = mysqli_query($mysqli, "UPDATE categories SET name='$nama_kategori' WHERE id=$id");
    // update user data
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        ...
                                        <a href="../dashboard.php?page=categories" class="btn btn-info">Kembali</a>
                                    </div>
                                    <!-- /.card-tools -->
                                </div>
