        ...
        if (is_uploaded_file($gambar['tmp_name'])) {
            if (!in_array(($tipe), $ext)) {
                ...
                if (move_uploaded_file($gambar['tmp_name'], $dir . $newName)) {
                    $result = mysqli_query($mysqli, "INSERT INTO tb_users(username,nama_operator,password, foto) VALUES('$username','$nama_operator','$password', '$newName')");
                            ...
                            <div class="card">
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="content_artikel">Foto</label>
