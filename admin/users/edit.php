    ...
    if (is_uploaded_file($gambar['tmp_name'])) {
        if (!in_array(($tipe), $ext)) {
            ...
            if (move_uploaded_file($gambar['tmp_name'], $dir . $newName)) {
                // update user data
                if ($password) {
                    $result = mysqli_query($mysqli, "UPDATE tb_users SET username='$username', nama_operator='$nama_operator', password='$password', foto='$newName' WHERE id=$id");
                } else {
                    $result = mysqli_query($mysqli, "UPDATE tb_users SET username='$username', nama_operator='$nama_operator', foto='$newName' WHERE id=$id");
                }
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        ...
                                        <a href="../dashboard.php?page=users" class="btn btn-info">Kembali</a>
                                    </div>
                                    <!-- /.card-tools -->
                                </div>
                                <div class="card-body">
