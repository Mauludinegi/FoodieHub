...
if (isset($_POST['order'])) {
    ...
    if ($orderedQuantity <= $quantity) { // Cek apakah jumlah yang dipesan tidak melebihi stok yang tersedia
        ...
        if ($order && $updateProduct) {
            echo "<script>alert('Orders Success');</script>";
        ...
        <div class="navbar">
            ...
            <div class="navbar-right">
                ...
                <div class="navbar-left-icon">
                    ...
                    <div class="cart">
                        <a href="../keranjang/index.php"><img src="../home/img/keranjang.png" alt="Keranjang Icon"
                                class="cart-icon" /></a>
                    </div>
                    <div class="cart">
                            ...
                            <div class="mr-4 space-y-2 w-full">
                                <div class="">
                                    ...
                                    <input type="text" id="Card Number" placeholder="Card Number" autocomplete="off"
                                        class="p-2 rounded-md border border-gray w-full" required>
                                </div>
                                ...
                                <div class="form-group form-group2">
                                    ...
                                    <input type="text" id="Street Address" placeholder="Street Address"
                                        autocomplete="off" class="p-2 rounded-md border border-gray w-full" required>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" id="Zip" placeholder="Zip" autocomplete="off"
                                            class="w-full p-2 rounded-md border border-gray " required>
                                    </div>
